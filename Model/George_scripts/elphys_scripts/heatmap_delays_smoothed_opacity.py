...
# ellipses
major_axis = max(3.96, 2.22) * 2.355
minor_axis = min(3.96, 2.22) * 2.355
major_axis2 = max(3.54, 2.9) * 2.355
minor_axis2 = min(3.54, 2.9) * 2.355
#major_axis3 = max(2, 1.88) * 2.355
#minor_axis3 = min(2, 1.88) * 2.355
ellipse = Ellipse((11.09, 11.29), width=major_axis, height=minor_axis, angle=-np.degrees(0.125), edgecolor='r', fc='None', lw=4)
ellipse2 = Ellipse((12.22, 17.49), width=major_axis2, height=minor_axis2, angle=-np.degrees(2.113), edgecolor='r', fc='None', lw=4)
