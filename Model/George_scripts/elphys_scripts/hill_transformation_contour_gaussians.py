...
# binary mask where gaussian_sensitivity > 0.6
...
##random_params = random_initial_parameters(bounds, 4)
##random_params_single = random_initial_parameters(bounds_single, 1)
##
##best_popt = None
