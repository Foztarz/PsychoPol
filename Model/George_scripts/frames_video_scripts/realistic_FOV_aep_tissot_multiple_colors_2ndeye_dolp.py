...
def main(image_path, output_path, azimuth_list, elevation_list, color_value_list, minor_axis):
    try:
        ...
        # Read the coordinates from the lists
        for azimuth_deg, elevation_deg, color_value in zip(azimuth_list, elevation_list, color_value_list):
            ...
            # Interpolate color based on the color_value (DoLP) 
