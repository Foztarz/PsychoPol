...
def main(image_path, output_path, azimuth_list, elevation_list, color_value_list, minor_axis):
    try:
        ...
        data_array[:, 3] = np.interp(data_array[:, 2], [min_slope, max_slope], [0, 180])
        ...
        np.savetxt("azimuth_elevation_slope_data.csv", data_array, delimiter="\t", comments="") # Azimuth,Elevation,Slope,Phi_Max,Phi_Max_2
