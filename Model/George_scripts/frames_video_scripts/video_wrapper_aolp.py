...
# this script makes frames for rotation angles of 5deg (of the original image) and draws the FOVs based on (geocentric) AoLP. CAREFUL!! THESE ARE NOT WEIGHTED AoLP VALUES WITH DoLP.
