...
def calculate_aolp_sim(x1, y1, center_x, center_y, sun_x, sun_y):
    ...
    azimuth2, elevation2 = 58, 0#cartesian_to_spherical(sun_x, sun_y, center_x, center_y)
...
def process_image(image_path, output_path):
    ...
    #sun_x, sun_y = spherical_to_cartesian(center_x, 58, 0)  # sun position, change accordingly
    #print(sun_x, sun_y)
