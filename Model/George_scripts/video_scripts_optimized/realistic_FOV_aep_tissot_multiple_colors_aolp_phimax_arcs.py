...
def main(image_path, output_path, azimuth_list, elevation_list, color_value_list, minor_axis):
    try:
        ...
        # calculate the phi max of the minimum intercept (posteriormost ommatidium) using the regression line based on Labhart paper
        max_phi_max = -0.4387 * int(min_intercept) + 470.8149
            
        # Map intercept values to the range [0, max_phi_max] for the 4th column
        ...
        np.savetxt("azimuth_elevation_arc_intercepts_data.csv", data_array, delimiter="\t", comments="") # Azimuth,Elevation,arc_intercept,Phi_Max,Phi_Max_2
