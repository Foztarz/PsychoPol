...
def process_line(args):
    line, img, img_width, img_height, center_x, center_y, minor_axis = args
    try:
        ...
        distance_matrix = np.where(distance_matrix > 50, 50, distance_matrix) # do this for consistency with ephys data
