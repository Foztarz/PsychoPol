---
title: "FictracOutputBatch"
output: html_document
---
#Details ---------------------------------------------------------------
>       AUTHOR:	James Foster              DATE: 2022 01 12
>     MODIFIED:	James Foster              DATE: 2022 01 28
>
...
> 
       USAGE:  Fill out user input (lines 40-45)
...
```
#If using parallel processing, set up the cluster to use
...
```{r Set up parallel processing, echo=FALSE}
...
```{r Process ".dat" files, echo=FALSE}
...
```{r Combine across all trials, echo=FALSE}
